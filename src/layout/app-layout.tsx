...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'outlet-manager', 'sales-associate', 'customer-service-representative'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Outlets', path: '/outlets', entity: 'outlet', service: AccessServiceEnum.PROJECT, icon: FiHome },
