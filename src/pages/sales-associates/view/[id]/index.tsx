...
import { getSalesAssociateById } from 'apiSdk/sales-associates';
import { SalesAssociateInterface } from 'interfaces/sales-associate';

function SalesAssociateViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('sales_associate', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/sales-associates/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Sales Quota" text={data?.sales_quota} />

                <FormListItem label="Total Sales" text={data?.total_sales} />
