...
export function OutletListPage(props: OutletListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOutlets({
        relations: ['company', 'user', 'sales_associate.count', 'tool.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['name.contains', 'location.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('sales_associate', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'sales_associate',
          header: 'Sales Associate',
          accessorKey: 'sales_associate',
          cell: ({ row: { original: record } }: any) => record?._count?.sales_associate,
        }
      : null,
